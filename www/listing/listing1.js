...
data.map(async (d) => {
  ...
  if (
    objData.origin.toLowerCase() == origin.toLowerCase() &&
    objData.destination.toLowerCase() == destination.toLowerCase()
  ) {
    let ac = "No";
    flag = true;
    if (objData.ac) {
    ...
    document.getElementById("list").innerHTML +=
      ...
      `</span>
                  ...
                  <p class="small ml-auto">
                    <i class="icofont-bus mr-2 text-danger"></i>`+objData.bus_no+`
                  </p>
                </div>
